...
- config_sets:
  - interrupt:
    - interrupt_sources: 'kI2C_SlavePendingInterruptEnable kI2C_SlaveDeselectedInterruptEnable'
    - enable_irq: 'true'
    - interrupt:
      - IRQn: 'FLEXCOMM1_IRQn'
      - enable_interrrupt: 'enabled'
...
static void FLEXCOMM1_init(void) {
  ...
  /* Enable interrupts */
  I2C_EnableInterrupts(FLEXCOMM1_PERIPHERAL, kI2C_SlavePendingInterruptEnable | kI2C_SlaveDeselectedInterruptEnable);
